...
// This one will be a special case
public class SWubble extends WubbleCharacter implements Selectable {
	private static final long serialVersionUID = -5941407610389070327L;

	private Quad _salienceQuad;

	public SWubble(String name) {
		super(name);
	...
	// This is exactly the same as the SheepGameCharacter version
